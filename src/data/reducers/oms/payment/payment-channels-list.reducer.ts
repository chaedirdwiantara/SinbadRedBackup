...
/** === TYPE HERE === */
type PaymentChannelsListInitialProps = models.ListItemProps<models.IPaymentChannelsList[]>;
/** === INITIAL STATE HERE === */
...
/** === FUNCTION HERE === */
export const paymentChannelsListReducer = simplifyReducer(paymentChannelsListInitialState, {
  /** ===> LIST */
  /** => list process */
