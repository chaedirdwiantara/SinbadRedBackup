...
import { paymentTermsAndConditionCreateInitialState, paymentTermsAndConditionCreateReducer } from './payment-terms-and-condition-create.reducer';
import {
  ...
  export const paymentReducer = (
    {
      ...
      paymentTCCreate,
      paymentTCDetail,
      paymentLastChannelCreate, paymentLastChannelDetail
    }: any,
    action: any,
  ) => ({
    ...
    paymentTermsAndConditionCreate: paymentTermsAndConditionCreateReducer(paymentTermsAndConditionCreate, action),
    paymentLastChannelCreate: paymentLastChannelCreateReducer(paymentLastChannelCreate, action),
  paymentLastChannelDetail: paymentLastChannelDetailReducer(paymentLastChannelDetail, action)
  });
